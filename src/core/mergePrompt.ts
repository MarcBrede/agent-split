export const MERGE_DELTA_PROMPT =
  "This is a transcript delta from a {agentName} sister session. " +
  "This is meant to give you context about what happened and what was learned in the sister session. " +
